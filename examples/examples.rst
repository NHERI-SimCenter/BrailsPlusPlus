...
The examples above give you a glimpse of how |app| can generate inventories for the built environment. But that is just the
beginning, |app| has many more ways to capture and work with data. Below, you will find a gallery of hands-on examples that let you explore these capabilities in action.
